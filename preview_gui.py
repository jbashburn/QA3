...
import main  # assumes main.generate_newsletter() returns the email body
import emailer  # assumes emailer.send_email(email_body) sends to all subscribers
...
preview_box = scrolledtext.ScrolledText(root, wrap=tk.WORD, font=("Helvetica", 12), width=70, height=20)
